  ...
  return (
    ...
    layout className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center relative z-10 backdrop-blur-sm  rounded-lg p-8">
      <h1 className='font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl'>
        ...
        <TypingAnimation className='font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl bg-gradient-to-r from-[#f3f] to-[#FF3232] bg-clip-text text-transparent'>
        share your passion
        </TypingAnimation>
      ...
      <div className="space-y-3 md:space-x-4">
        <Button className='font-bold h-11 ' variant={'outline'} onClick={() =>  router.push('/explore')}>
          Explore Communities
        </Button>
      </div>
    </motion.div>
